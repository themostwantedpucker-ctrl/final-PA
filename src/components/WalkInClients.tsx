          ...
          <CardContent className="space-y-3">
            <div id="receipt-content" className="text-center border-2 border-dashed border-border p-4 bg-muted/50">
              <div className="receipt">
                <h3 className="font-bold mb-4" style={{ fontSize: '27px' }}>{settings.siteName || 'PARKING RECEIPT'}</h3>
                <div className="text-lg font-mono" style={{lineHeight: '1.6', fontSize: '21px'}}>
  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '18px', letterSpacing: '2px', fontSize: '21px' }}>
